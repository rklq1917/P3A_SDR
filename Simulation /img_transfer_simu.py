...
# Title: Img Transfer Simu
# Generated: Mon Jan 15 18:43:04 2018
##################################################
...
class img_transfer_simu(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Img Transfer Simu")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Img Transfer Simu")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "img_transfer_simu")
        ...
        self.payload_lenght = payload_lenght = 0
        self.noise_volt = noise_volt = 0.0100
        self.freq_offset = freq_offset = 0.000
        ...
        self._time_offset_range = Range(0.9, 1.1, 0.005, 1.000, 200)
        ...
        self._noise_volt_range = Range(0, 1, 0.01, 0.0100, 200)
        ...
        self._freq_offset_range = Range(-0.1, 0.1, 0.001, 0.000, 200)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, "/home/tochou/SDR-ACARS/dqpsk_receiver/sources_files/babouin.png", True)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, "/home/tochou/SDR-ACARS/dqpsk_receiver/out_files/img_out.png", False)
    ...
    def get_payload_lenght(self):
        return self.payload_lenght

    def set_payload_lenght(self, payload_lenght):
...
def main(top_block_cls=img_transfer_simu, options=None):
