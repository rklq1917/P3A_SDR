...
# Title: Dqpsk Simu
# Generated: Wed Jan 17 16:41:21 2018
##################################################
...
class dqpsk_simu(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Dqpsk Simu")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Dqpsk Simu")
        ...
        self.settings = Qt.QSettings("GNU Radio", "dqpsk_simu")
        ...
        self.qpsk_gray = qpsk_gray = digital.constellation_rect(([0.707+0.707j, -0.707+0.707j, 0.707-0.707j,- 0.707-0.707j]), ([0, 1, 2, 3]), 4, 2, 2, 1, 1).base()
        ...
        self._time_offset_range = Range(0.9, 1.1, 0.005, 1.00, 200)
        ...
        self.connect((self.blocks_delay_1, 0), (self.blks2_error_rate_0, 1))
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0_0, 0), (self.blocks_delay_1, 0))
...
def main(top_block_cls=dqpsk_simu, options=None):
