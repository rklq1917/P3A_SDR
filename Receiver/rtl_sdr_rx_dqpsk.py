...
# Title: Rtl Sdr Rx Dqpsk
# Generated: Mon Jan 22 14:52:25 2018
##################################################
...
class rtl_sdr_rx_dqpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/tochou/SDR-ACARS/dqpsk_receiver/out_files/txt_RX.txt', False)
        ...
        self.connect((self.rtlsdr_source_0, 0), (self.digital_pfb_clock_sync_xxx_0, 0))
...
def main(top_block_cls=rtl_sdr_rx_dqpsk, options=None):
